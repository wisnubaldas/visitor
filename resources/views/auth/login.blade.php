	                    ...
	                    <form class="theme-form login-form" method="POST" action="{{ route('login') }}">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="input-group">
	                                ...
	                                <input class="form-control" type="email" required="" placeholder="admin@gmail.com" name="email" />
	                            </div>
	                        </div>
	                        <div class="form-group">
	                        ...
	                        <div class="form-group col-12"><button class="btn btn-primary btn-block" type="submit">Sign in</button></div>
